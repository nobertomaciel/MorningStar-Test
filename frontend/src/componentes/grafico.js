            ...
            {isVisible && (
                <div className='modalChart2'>
                    <div className='modalChart3'>
                        <svg onClick={handleClick} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="p-icon p-dialog-header-close-icon closeIcon" aria-hidden="true" data-pc-section="closebuttonicon">
